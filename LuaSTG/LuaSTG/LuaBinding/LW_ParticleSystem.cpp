...
inline void
lua_push_vec2(lua_State* L, core::Vector2F const& v)
{
...
inline core::Vector2F
luaL_check_vec2(lua_State* L, int idx)
{
    core::Vector2F ret;
...
inline void
Color4B_to_Color4f(core::Color4B c, float d[4])
{
...
inline void
lua_push_color4f(lua_State* L, float c[4])
{
...
inline void
luaL_check_color4f(lua_State* L, int idx, float c[4])
{
    if(!lua_istable(L, idx)) {
