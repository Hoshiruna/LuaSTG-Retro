...
namespace luastg
{
    ...
    ResourceParticleImpl::ResourceParticleImpl(const char* name, const hgeParticleSystemInfo& pinfo, core::Graphics::ISprite* sprite, double a, double b, bool rect)
        : ResourceBaseImpl(ResourceType::Particle, name), m_HalfSizeX(a), m_HalfSizeY(b), m_bRectangle(rect)
    {
    ...
    size_t ParticlePoolImpl::GetAliveCount()
    {
        return m_iAlive;
    }
    BlendMode ParticlePoolImpl::GetBlendMode()
    {
        return m_Info.eBlendMode;
    }
    void ParticlePoolImpl::SetBlendMode(BlendMode m)
    {
        m_Info.eBlendMode = m;
    }
    ...
    int ParticlePoolImpl::GetEmission()
    {
        return m_Info.tParticleSystemInfo.nEmission;
    }
    void ParticlePoolImpl::SetEmission(int e)
    {
        m_Info.tParticleSystemInfo.nEmission = e;
    }
    uint32_t ParticlePoolImpl::GetSeed()
    {
        return m_RandomSeed;
    }
    ...
    bool ParticlePoolImpl::IsActived()
    {
        return m_iStatus == Status::Alive;
    }
    ...
    core::Vector2F ParticlePoolImpl::GetCenter()
    {
        return m_vCenter;
    }
    void ParticlePoolImpl::SetRotation(float r)
    {
        m_fDirection = r;
    }
    float ParticlePoolImpl::GetRotation()
    {
        return m_fDirection;
    }
