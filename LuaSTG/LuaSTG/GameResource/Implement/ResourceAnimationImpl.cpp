...
namespace luastg
{
    ResourceAnimationImpl::ResourceAnimationImpl(
        const char* name,
        core::SmartReference<IResourceTexture> tex,
        float x,
        float y,
        float w,
        float h,
        ...
        double b,
        bool rect)
        : ResourceBaseImpl(ResourceType::Animation, name), m_Interval(intv), m_HalfSizeX(a), m_HalfSizeY(b), m_bRectangle(rect), m_is_sprite_cloned(true)
    {
        // 分割纹理
    ...
    ResourceAnimationImpl::ResourceAnimationImpl(
        ...
        double b,
        bool rect)
        : ResourceBaseImpl(ResourceType::Animation, name), m_Interval(intv), m_HalfSizeX(a), m_HalfSizeY(b), m_bRectangle(rect), m_is_sprite_cloned(false)
    {
