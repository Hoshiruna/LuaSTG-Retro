        ...
        XInputLoader()
        {
            ...
            for(auto& v : dll_names) {
                if(HMODULE dll = ::LoadLibraryW(v.data())) {
                    ...
                    api_XInputGetState = (decltype(api_XInputGetState))::GetProcAddress(dll, "XInputGetState");
                    api_XInputSetState = (decltype(api_XInputSetState))::GetProcAddress(dll, "XInputSetState");
                    api_XInputGetCapabilities = (decltype(api_XInputGetCapabilities))::GetProcAddress(dll, "XInputGetCapabilities");
                    break;
                }
            }
        }
