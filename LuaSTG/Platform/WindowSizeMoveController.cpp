...
namespace Platform
{
    ...
    void WindowSizeMoveController::setEnable(BOOL b)
    {
        is_enable = b;
    }
    void WindowSizeMoveController::setMinimizeButtonRect(RECT rc)
    {
        minimize_button_rect = rc;
    }
    void WindowSizeMoveController::setCloseButtonRect(RECT rc)
    {
        close_button_rect = rc;
    }
    void WindowSizeMoveController::setTitleBarRect(RECT rc)
    {
        title_bar_rect = rc;
    }
    ...
    WindowSizeMoveController::WindowSizeMoveController()
        : window(NULL), title_bar_rect({}), minimize_button_rect({}), close_button_rect({}), last_mouse_pos({}), last_mouse_dpos({}), last_window_pos({}), is_enable(FALSE), is_size_or_move(FALSE), is_minimize_button_down(FALSE), is_close_button_down(FALSE)
    {
    }
    WindowSizeMoveController::~WindowSizeMoveController()
    {
