...
namespace platform::windows
{
    ...
    private:
        ...
        void drawTitleBar()
        {
            ...
            if(title_text_width > 0) {
                ...
                dwrite_factory->CreateTextLayout(
                    title_text.c_str(), static_cast<UINT>(title_text.length()), dwrite_text_format_title.get(), title_text_width, (title_bar_height - title_bottom_padding) * scaling, title_text_layout.put());
                ...
                if(metrics.width > title_text_width) {
                    ...
                    dwrite_factory->CreateTextLayout(
                        L"...", 3, dwrite_text_format_title.get(), 100.0f, (title_bar_height - title_bottom_padding) * scaling, title_text_more_layout.put());
        ...
        void drawButtons()
        {
            ...
            dwrite_factory->CreateTextLayout(
                icon_schema.chrome_minimize, 1, dwrite_text_format_icon.get(), button_icon_width * scaling, button_icon_height * scaling, minimize_icon_text_layout.put());
            ...
            dwrite_factory->CreateTextLayout(
                window_maximized ? icon_schema.chrome_restore : icon_schema.chrome_maximize, 1, dwrite_text_format_icon.get(), button_icon_width * scaling, button_icon_height * scaling, maximize_icon_text_layout.put());
            ...
            dwrite_factory->CreateTextLayout(
                icon_schema.chrome_close, 1, dwrite_text_format_icon.get(), button_icon_width * scaling, button_icon_height * scaling, close_icon_text_layout.put());
    ...
    public:
            ...
            switch(message) {
                ...
                case WM_MOUSEMOVE:
                    if constexpr(true) {
                        ...
                        if(!enter_title_bar && (x >= (win32_window_width - button_width * scaling * 3) || y < (1.0f * scaling)) && y < (title_bar_height * scaling)) {
        ...
        bool setClientSize(HWND window, UINT width, UINT height)
        {
            ...
            return FALSE != SetWindowPos(window, nullptr, 0, 0, rc.right - rc.left, rc.bottom - rc.top, SWP_NOZORDER | SWP_NOMOVE | SWP_FRAMECHANGED);
        }
...
namespace platform::windows
{
    ...
    ImmersiveTitleBarController::ImmersiveTitleBarController()
        : impl(new Impl())
    {
    }
    ImmersiveTitleBarController::ImmersiveTitleBarController(ImmersiveTitleBarController&& other) noexcept
