...
bool
write_blob_to_file(winrt::com_ptr<ID3DBlob> blob, output_config_t const& config, std::ofstream& file)
{
    assert(blob);
...
bool
write_blob_to_file(winrt::com_ptr<ID3DBlob> blob, output_config_t const& config)
{
...
bool
compile_shader(compile_config_t const& config, winrt::com_ptr<ID3DBlob>& blob)
{
...
bool
process_shader(compile_config_t const& compile_config, output_config_t const& output_config)
{
