...
namespace core::Graphics
{
    ...
    struct SamplerState
    {
        ...
        SamplerState()
            : filer(Filter::Linear), address_u(TextureAddressMode::Clamp), address_v(TextureAddressMode::Clamp), address_w(TextureAddressMode::Clamp), mip_lod_bias(0.0f), max_anisotropy(1u), min_lod(-FLT_MAX), max_lod(FLT_MAX), border_color(BorderColor::Black)
        {
        }
        SamplerState(Filter filter_, TextureAddressMode address_)
            : filer(filter_), address_u(address_), address_v(address_), address_w(address_), mip_lod_bias(0.0f), max_anisotropy(1u), min_lod(-FLT_MAX), max_lod(FLT_MAX), border_color(BorderColor::Black)
        {
        }
    };
    ...
    struct IDevice : IReferenceCounted
    {
        ...
        virtual bool createTextureFromData(IData* data, bool mipmap, ITexture2D** pp_texture) = 0;
...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ISamplerState>()
    {
        return UUID::parse("e3d354b2-5ba5-5ead-8e63-0d3516b45c05");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ITexture2D>()
    {
        return UUID::parse("5477054a-61c9-5071-9339-a9959e538a21");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IRenderTarget>()
    {
        return UUID::parse("2753f336-07b6-5e69-95b1-46f1125531fa");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IDepthStencilBuffer>()
    {
        return UUID::parse("2c92426c-9703-57aa-88e6-073957b0d92c");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IBuffer>()
    {
        return UUID::parse("089911ec-bd44-519e-a1e6-41a0e8e4626c");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IDevice>()
    {
        return UUID::parse("f6b65f2d-4307-597e-bc16-f3504ef89def");
    }
}
