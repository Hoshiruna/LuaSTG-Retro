...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IDisplay>()
    {
        return UUID::parse("9432a56d-e3d2-5173-b313-a9581b373155");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IWindow>()
    {
        return UUID::parse("7be6255c-08f5-5cd4-81d7-2f490256f2e9");
    }
}
