...
set(LUASTG_GRAPHICS_BACKEND "D3D11" CACHE STRING "Runtime graphics backend: D3D11 or SDLGPU")
set_property(CACHE LUASTG_GRAPHICS_BACKEND PROPERTY STRINGS D3D11 SDLGPU)
if (NOT LUASTG_GRAPHICS_BACKEND MATCHES "^(D3D11|SDLGPU)$")
    message(FATAL_ERROR "LUASTG_GRAPHICS_BACKEND must be D3D11 or SDLGPU")
endif ()
set(LUASTG_USE_SDLGPU OFF)
if (LUASTG_BUILD_RUNTIME AND LUASTG_GRAPHICS_BACKEND STREQUAL "SDLGPU")
    set(LUASTG_USE_SDLGPU ON)
endif ()
