...
namespace
{
    ...
    public:
        ...
        explicit DirectWriteFontFileStream(core::IData* const data) noexcept
            : m_data(data) {}
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE CreateStreamFromKey(
            ...
            _COM_Outptr_ IDWriteFontFileStream** fontFileStream) override
        {
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE MoveNext(
            _Out_ BOOL* hasCurrentFile) override
        {
        ...
        HRESULT STDMETHODCALLTYPE GetCurrentFontFile(
            _COM_Outptr_ IDWriteFontFile** fontFile) override
        {
            if(fontFile == nullptr) {
                return E_POINTER;
            }
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE CreateEnumeratorFromKey(
            ...
            _COM_Outptr_ IDWriteFontFileEnumerator** fontFileEnumerator) override
        {
