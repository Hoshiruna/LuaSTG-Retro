...
namespace
{
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE GetSize(
            ...
            /* [out] */ __RPC__out UINT* puiHeight) override
        {
        ...
        HRESULT STDMETHODCALLTYPE GetStride(
            /* [out] */ __RPC__out UINT* pcbStride) override
        {
        ...
        HRESULT STDMETHODCALLTYPE GetDataPointer(
            ...
            /* [size_is][size_is][out] */ __RPC__deref_out_ecount_full_opt(*pcbBufferSize) WICInProcPointer* ppbData) override
        {
        ...
        HRESULT STDMETHODCALLTYPE GetPixelFormat(
            /* [out] */ __RPC__out WICPixelFormatGUID* pPixelFormat) override
        {
    ...
    public:
        ...
        HRESULT STDMETHODCALLTYPE GetResolution(
            ...
            /* [out] */ __RPC__out double* pDpiY) override
        {
        ...
        HRESULT STDMETHODCALLTYPE CopyPalette(
            /* [in] */ __RPC__in_opt IWICPalette* pIPalette) override
        {
        ...
        HRESULT STDMETHODCALLTYPE CopyPixels(
            ...
            /* [size_is][out] */ __RPC__out_ecount_full(cbBufferSize) BYTE* pbBuffer) override
        {
            ...
            if(prc != nullptr) {
                if(
                    prc->X < 0 || prc->X > static_cast<INT>(size.x) || prc->Y < 0 || prc->Y > static_cast<INT>(size.y) || prc->Width < 0 || prc->Width > (static_cast<INT>(size.x) - prc->X) || prc->Height < 0 || prc->Height > (static_cast<INT>(size.y) - prc->Y)) {
                    return E_INVALIDARG;
                }
                rc = *prc;
            }
        ...
        HRESULT STDMETHODCALLTYPE Lock(
            ...
            /* [in] */ DWORD flags,
            /* [out] */ __RPC__deref_out_opt IWICBitmapLock** ppILock) override
        {
            if(ppILock == nullptr) {
                return E_INVALIDARG;
            }
            ...
            if(prcLock != nullptr) {
                if(
                    prcLock->X < 0 || prcLock->X > static_cast<INT>(size.x) || prcLock->Y < 0 || prcLock->Y > static_cast<INT>(size.y) || prcLock->Width < 0 || prcLock->Width > (static_cast<INT>(size.x) - prcLock->X) || prcLock->Height < 0 || prcLock->Height > (static_cast<INT>(size.y) - prcLock->Y)) {
                    return E_INVALIDARG;
                }
                rc = *prcLock;
            }
        ...
        explicit WICBitmapImpl(core::IImage* const image) noexcept
            : m_image(image)
        {
