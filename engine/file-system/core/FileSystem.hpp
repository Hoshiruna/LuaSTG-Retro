...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IFileSystemEnumerator>()
    {
        return UUID::parse("49e754fe-15af-58ac-9632-d9ed06b3f0d4");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IFileSystem>()
    {
        return UUID::parse("61c1bc5e-6e1e-5fe2-958c-527e85138010");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IFileSystemOS>()
    {
        return UUID::parse("f21693cb-e71a-5877-9786-7815d4af4ffd");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IFileSystemArchive>()
    {
        return UUID::parse("a36e930b-4fb8-5061-b88b-127e5200474e");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IFileSystemFileSystemEnumerator>()
    {
        return UUID::parse("21f75b75-0d43-5fa1-93d0-9924036782b6");
    }
