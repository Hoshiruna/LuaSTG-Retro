...
namespace core
{
    ...
    double AudioPlayerXAudio2::getTotalTime()
    {
        assert(false);
        return 0.0;
    }
    double AudioPlayerXAudio2::getTime()
    {
        assert(false);
        return 0.0;
    }
    ...
    void AudioPlayerXAudio2::updateFFT()
    {
        assert(false);
    }
    uint32_t AudioPlayerXAudio2::getFFTSize()
    {
        assert(false);
        return 0;
    }
    float const* AudioPlayerXAudio2::getFFT()
    {
        assert(false);
        return s_empty_fft_data;
    }
