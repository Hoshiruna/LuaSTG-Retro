...
namespace
{
    ...
    {
        return magic[0] == 'O' && magic[1] == 'g' && magic[2] == 'g' && magic[3] == 'S';
    }
    ...
    {
        return (info.bits_per_sample == 8 || info.bits_per_sample == 16 || info.bits_per_sample == 24 || info.bits_per_sample == 32) && (info.channels == 1 || info.channels == 2);
    }
