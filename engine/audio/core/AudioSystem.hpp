...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IAudioAsset>()
    {
        return UUID::parse("d7512d6b-79b0-5fba-9064-48ff51c64a24");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IAudioSystem>()
    {
        return UUID::parse("8bc4e618-ba9e-5af0-bd69-1a5d4ac0f6e3");
    }
}
