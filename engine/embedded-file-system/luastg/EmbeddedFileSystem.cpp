...
namespace luastg
{
    ...
    public:
        ...
        core::FileSystemNodeType getNodeType() override
        {
            ...
            return generated::files[m_index].name.ends_with("/"sv) ? core::FileSystemNodeType::directory : core::FileSystemNodeType::file;
        }
        ...
        EmbeddedFileSystemEnumerator(std::string_view const& directory, bool const recursive)
    ...
    public:
        ...
        core::FileSystemNodeType getNodeType(std::string_view const& name) override
        {
            for(auto const& file : generated::files) {
                if(file.name == name) {
                    return file.name.ends_with('/') ? core::FileSystemNodeType::directory : core::FileSystemNodeType::file;
                }
            }
            return core::FileSystemNodeType::unknown;
        }
