...
#define GetterSetterBoolean(_class_, _field_, _method_name_)  \
    inline bool is##_method_name_() const noexcept            \
    {                                                         \
        return _field_;                                       \
    };                                                        \
    inline _class_& set##_method_name_(bool const _field_##_) \
    {                                                         \
        _field_ = _field_##_;                                 \
        return *this;                                         \
    }
...
#define GetterSetterString(_class_, _field_, _method_name_)                \
    inline bool has##_method_name_() const noexcept                        \
    {                                                                      \
        return !((_field_).empty());                                       \
    };                                                                     \
    inline std::string const& get##_method_name_() const noexcept          \
    {                                                                      \
        return _field_;                                                    \
    };                                                                     \
    inline _class_& set##_method_name_(std::string_view const& _field_##_) \
    {                                                                      \
        _field_ = _field_##_;                                              \
        return *this;                                                      \
    }
...
#define GetterSetterPrimitive(_class_, _type_, _field_, _method_name_) \
    inline _type_ get##_method_name_() const noexcept                  \
    {                                                                  \
        return _field_;                                                \
    };                                                                 \
    inline _class_& set##_method_name_(_type_ const _field_##_)        \
    {                                                                  \
        _field_ = _field_##_;                                          \
        return *this;                                                  \
    }
