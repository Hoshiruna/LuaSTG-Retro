...
namespace
{
    ...
    core::Graphics::IRenderer::TextureAlphaType getTextureAlphaMode(core::ITexture2D* const b)
    {
        ...
        return b->isPremultipliedAlpha() ? core::Graphics::IRenderer::TextureAlphaType::PremulAlpha : core::Graphics::IRenderer::TextureAlphaType::Normal;
    }
...
namespace core::Graphics
{
    ...
    bool PostEffectShader_D3D11::apply(IRenderer* const p_renderer)
    {
        ...
        for(auto& v : m_texture2d_map) {
            ...
            const auto sampler = v.second.texture->getSamplerState() != nullptr ? v.second.texture->getSamplerState() : default_sampler;
    ...
    PostEffectShader_D3D11::PostEffectShader_D3D11(GraphicsDevice* p_device, StringView path, bool is_path_)
        : m_device(p_device), source(path), is_path(is_path_)
    {
...
namespace core::Graphics
{
    ...
    void Renderer_D3D11::bindTextureSamplerState(ITexture2D* const texture)
    {
        ...
        const auto sampler = texture_sampler != nullptr ? texture_sampler : _sampler_state[IDX(SamplerState::LinearClamp)].get(); // default sampler: linear+clamp
    ...
    bool Renderer_D3D11::drawPostEffect(
        ...
        Vector4F const* cv,
        size_t cv_n,
        ITexture2D* const* p_tex_arr,
        SamplerState const* sv,
        size_t tv_sv_n)
    {
        assert(p_effect);
        ...
        DirectX::XMStoreFloat4x4(&vp_matrix, DirectX::XMMatrixOrthographicOffCenterLH(0.0f, rtv_w, 0.0f, rtv_h, 0.0f, 1.0f));
        ...
        const float size_viewport[8] = {
            ...
            0.0f,
            0.0f,
            _state_set.viewport.a.x,
            _state_set.viewport.a.y,
            _state_set.viewport.b.x,
            _state_set.viewport.b.y,
        };
    ...
    void Renderer_D3D11::applyScissorRect(const RectF& rect)
    {
        m_device->getCommandbuffer()->setScissorRect(
            static_cast<int32_t>(rect.a.x), static_cast<int32_t>(rect.a.y), static_cast<uint32_t>(rect.b.x - rect.a.x), static_cast<uint32_t>(rect.b.y - rect.a.y));
    }
