...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IMesh>()
    {
        return UUID::parse("91e67fcf-1cec-5bee-a80b-ac46f878462d");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IMeshRenderer>()
    {
        return UUID::parse("5c88cabe-95b0-5854-a7fd-de92a6eb5916");
    }
}
