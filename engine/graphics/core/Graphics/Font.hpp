...
namespace core::Graphics
{
    ...
    struct ITextRenderer : public IReferenceCounted
    {
        ...
        virtual bool drawTextInSpace(StringView str,
            ...
            Vector3F const& right_vec,
            Vector3F const& down_vec,
...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IGlyphManager>()
    {
        return UUID::parse("2c719bf6-dbf1-5d51-86c6-8ea3c1d5a7f0");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ITextRenderer>()
    {
        return UUID::parse("23c381e5-4769-5caf-9623-5f050c0f9aba");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ITextRenderer2>()
    {
        return UUID::parse("3308ba67-afc6-54ef-938b-7aeb006876a0");
    }
}
