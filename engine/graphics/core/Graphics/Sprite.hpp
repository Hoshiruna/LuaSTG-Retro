...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ISprite>()
    {
        return UUID::parse("291cd55f-be6c-5abf-a014-cbd47ab655a3");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::ISpriteRenderer>()
    {
        return UUID::parse("928af8d9-f387-557b-a7d9-d1395b9bc0f1");
    }
}
