...
namespace core::Graphics
{
    ...
    struct IRenderer : public IReferenceCounted
    {
        ...
        struct DrawVertex
        {
            ...
            DrawVertex()
                : x(0.0f), y(0.0f), z(0.0f), u(0.0f), v(0.0f), color(0u) {}
        ...
        virtual bool createPostEffectShaderFromSource(StringView source, IPostEffectShader** pp_effect, StringView source_name = {}) = 0;
...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IPostEffectShader>()
    {
        return UUID::parse("d9bbdce5-bb1a-50fe-af44-0149e7e3f1b4");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IModel>()
    {
        return UUID::parse("31d5322d-0165-56e4-bda6-914e131eccf9");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<Graphics::IRenderer>()
    {
        return UUID::parse("0ebdb9dc-847f-5827-bf0a-a902494b84bc");
    }
}
