...
#define SL
    ...
    {
    public:
        hresult_error(hresult const code, std::string const& message)
            : std::runtime_error(message.c_str()), m_code(code) {}
        hresult_error(hresult const code, char const* message)
