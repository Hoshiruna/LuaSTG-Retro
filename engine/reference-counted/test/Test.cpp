...
namespace core
{
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IAlpha>()
    {
        return UUID::parse("b009fba2-0cc7-5a14-b703-d908bfd9547b");
    }
    ...
    template<>
    constexpr InterfaceId getInterfaceId<IResource>()
    {
        return UUID::parse("b7c0c21c-46fd-5a06-b8d2-637bb0281325");
    }
}
