...
#define CORE_INTERFACE struct CORE_NO_VIRTUAL_TABLE

#define CORE_INTERFACE_ID(NAME, ID)              \
    template<>                                   \
    constexpr InterfaceId getInterfaceId<NAME>() \
    {                                            \
...
namespace core
{
    ...
    {
        return Interface::interface_uuid;
    }
