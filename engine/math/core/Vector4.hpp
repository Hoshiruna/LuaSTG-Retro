...
namespace core
{
    ...
    struct Vector4
    {
        ...
        Vector4() noexcept
            : x(0), y(0), z(0), w(0) {}
        Vector4(Vector2<T> const& xy, T const z, T const w) noexcept
            : x(xy.x), y(xy.y), z(z), w(w) {}
        Vector4(Vector3<T> const& xyz, T const w) noexcept
            : x(xyz.x), y(xyz.y), z(xyz.z), w(w) {}
        Vector4(T const x, T const y, T const z, T const w) noexcept
            : x(x), y(y), z(z), w(w) {}
